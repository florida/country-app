class Country < ActiveRecord::Base
  ...
  ALLOWED_COUNTRIES = ["Afghanistan", "Aland Islands", "Albania", "Algeria", "American Samoa", "Andorra", "Angola",
  ...
  validates :gdp, :presence => true
  validates :population, :numericality => { :only_integer => true }
  validates :median_age, :numericality => true
  validates :life_expectancy, :numericality => true
  validates_inclusion_of :name, :in => ALLOWED_COUNTRIES
